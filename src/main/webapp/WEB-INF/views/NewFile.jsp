		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="/SpedFiscal/">Sped Fiscal <h4 style="float:right">Web Service</h4></a></h1>
				</div>
			...
			<div class="agileits_w3layouts_banner_info">
				<h2>Creating new ideas</h2>
				<p>welcome to Sped Fiscal Web Service</p>
		...
		<div class="container">
			<div class="w3_agileits_banner_bottom_grids">
				<div class="col-md-6 w3_agileits_banner_bottom_grid">
					<h3>Pontos Importantes sobre <span>Sped Fiscal</span></h3>
					<div class="wthree_banner_btm_grid">
						<div class="wthree_banner_btm_grid1">
							<h4>Easy to customize</h4>
							<p>Vivamus eget augue bibendum, molestie lacus in, venenatis felis. 
								Donec elementum metus non mi ullamcorper.</p>
				...
				<div class="col-md-6 w3_agileits_banner_bottom_grid_right">
					<div class="slider">
						<ul class="slides">
							<li class="slide">
								<figure>
									<img src="<c:url value='/resources/resource_monetery/images/2.jpg'/>" alt=" " class="img-responsive" />
								</figure>
							</li>
							<li class="slide">
								<figure>
									<img src="<c:url value='/resources/resource_monetery/images/1.jpg'/>" alt=" " class="img-responsive" />
								</figure>
							</li>
							<li class="slide">
								<figure>
									<img src="<c:url value='/resources/resource_monetery/images/3.jpg'/>" alt=" " class="img-responsive" />
								</figure>
							</li>
							<li class="slide">
								<figure>
									<img src="<c:url value='/resources/resource_monetery/images/4.jpg'/>" alt=" " class="img-responsive" />
								</figure>
							</li>						
							<li class="slide">
								<figure>
									<img src="<c:url value='/resources/resource_monetery/images/5.jpg'/>" alt=" " class="img-responsive" />
								</figure>
							</li>
						</ul>
					</div> 
						...
						<ul class="slides">
							...
							<li>
								<div class="w3_agileits_testimonial_grid">
									...
									<img src="<c:url value='/resources/resource_monetery/images/6.png'/>" alt=" " class="img-responsive" />
							...
							<li>
								<div class="w3_agileits_testimonial_grid">
									<p><i class="fa fa-quote-right" aria-hidden="true"></i>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum 
										dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non 
										proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
									<img src="<c:url value='/resources/resource_monetery/images/5.png'/>" alt=" " class="img-responsive" />
									<h4>Vitor Oliveira <span>Senior Designer</span></h4>
								</div>
							</li>
						</ul>
					</div>
...
<div class="footer">
		<div class="container">
			...
			<p>2017 Sped Fiscal Web Service.| Design by <a href="http://w3layouts.com/">Roney Amorim</a></p>
		</div>
	</div>
<script type="text/javascript">
